...
1.0 Motivação
    ...
    O presente projeto nasceu da necessidade de finalizar um trabalho de conclusão do curso de Gestão em T.i da
    Universidade Cruzeiro do Sul. A ideia da aplicação é realizar o gerênciamento de um estabelecimento comercial,
    para isso o presente projeto irá sempre que possível observar as etapas de construção da aplicação:
